...
const SERVICES = [
  ...
  { id: 'heavy-duty-removal', label: 'Heavy Duty Removal', price: 120, duration: 60, aliases: ['Heavy Duty Removal, Exorcism or Emergency Removal Session'] },
  { id: 'exorcism-session', label: 'Exorcism Session', price: 120, duration: 60 },
  { id: 'emergency-removal-session', label: 'Emergency Removal Session', price: 120, duration: 60 },
...
function findService(value) {
  ...
  return SERVICES.find(service => (
    ...
    (service.aliases || []).some(alias => normalize(alias) === needle)
  )) || null;
}
