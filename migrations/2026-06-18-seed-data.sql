...
-- content is NOT NULL; using chief_concern + energy_findings as the plain-text content value
INSERT INTO session_notes (id, session_id, client_id, content, chief_concern, energy_findings, created_at)
VALUES
  ('33333333-0001-0000-0000-000000000001','22222222-0001-0000-0000-000000000001','11111111-0001-0000-0000-000000000001','Chief concern: energetic overwhelm and anxiety. Energy findings: Dense energy in upper chakras. Solar plexus blocked.','energetic overwhelm and anxiety','Dense energy in upper chakras. Solar plexus blocked.','2025-10-01'),
  ('33333333-0002-0000-0000-000000000001','22222222-0002-0000-0000-000000000001','11111111-0001-0000-0000-000000000001','Chief concern: energetic overwhelm and anxiety. Energy findings: Solar plexus clearing progressing. Lighter field.','energetic overwhelm and anxiety','Solar plexus clearing progressing. Lighter field.','2025-11-01'),
  ('33333333-0003-0000-0000-000000000001','22222222-0003-0000-0000-000000000001','11111111-0001-0000-0000-000000000001','Chief concern: energetic overwhelm and anxiety. Energy findings: Field now clear. Client maintaining grounding.','energetic overwhelm and anxiety','Field now clear. Client maintaining grounding.','2026-01-15'),

  ('33333333-0001-0000-0000-000000000002','22222222-0001-0000-0000-000000000002','11111111-0002-0000-0000-000000000002','Chief concern: chronic pain and root chakra blockage. Energy findings: Root chakra severely blocked. Pain imprints throughout lower field.','chronic pain and root chakra blockage','Root chakra severely blocked. Pain imprints throughout lower field.','2025-10-10'),
  ('33333333-0002-0000-0000-000000000002','22222222-0002-0000-0000-000000000002','11111111-0002-0000-0000-000000000002','Chief concern: chronic pain and root chakra blockage. Energy findings: Root chakra opening. Pain response reducing.','chronic pain and root chakra blockage','Root chakra opening. Pain response reducing.','2025-11-15'),

  ('33333333-0001-0000-0000-000000000005','22222222-0001-0000-0000-000000000005','11111111-0005-0000-0000-000000000005','Chief concern: trauma and energetic overwhelm. Energy findings: Multiple energy bodies disrupted. Strong trauma imprinting.','trauma and energetic overwhelm','Multiple energy bodies disrupted. Strong trauma imprinting.','2025-10-05'),
  ('33333333-0002-0000-0000-000000000005','22222222-0002-0000-0000-000000000005','11111111-0005-0000-0000-000000000005','Chief concern: trauma and energetic overwhelm. Energy findings: Trauma field lightening. Emotional body responding well.','trauma and energetic overwhelm','Trauma field lightening. Emotional body responding well.','2025-11-10'),
  ('33333333-0003-0000-0000-000000000005','22222222-0003-0000-0000-000000000005','11111111-0005-0000-0000-000000000005','Chief concern: trauma and energetic overwhelm. Energy findings: Major shift in trauma field. Client lighter than ever.','trauma and energetic overwhelm','Major shift in trauma field. Client lighter than ever.','2026-01-05'),

  ('33333333-0001-0000-0000-000000000006','22222222-0001-0000-0000-000000000006','11111111-0006-0000-0000-000000000006','Chief concern: anxiety and sleep disruption. Energy findings: Crown chakra overactive. Mental field scattered.','anxiety and sleep disruption','Crown chakra overactive. Mental field scattered.','2025-11-05'),
  ('33333333-0002-0000-0000-000000000006','22222222-0002-0000-0000-000000000006','11111111-0006-0000-0000-000000000006','Chief concern: anxiety and sleep disruption. Energy findings: Crown settling. Sleep field improving.','anxiety and sleep disruption','Crown settling. Sleep field improving.','2025-12-10'),

  ('33333333-0001-0000-0000-000000000007','22222222-0001-0000-0000-000000000007','11111111-0007-0000-0000-000000000007','Chief concern: chronic fatigue and energy depletion. Energy findings: Root and sacral severely depleted. Energetic drain attachments present.','chronic fatigue and energy depletion','Root and sacral severely depleted. Energetic drain attachments present.','2025-11-20'),

  ('33333333-0001-0000-0000-000000000009','22222222-0001-0000-0000-000000000009','11111111-0009-0000-0000-000000000009','Chief concern: grief and emotional overwhelm. Energy findings: Heart chakra heavily blocked with grief energy. Dense emotional field.','grief and emotional overwhelm','Heart chakra heavily blocked with grief energy. Dense emotional field.','2025-11-25'),
  ('33333333-0002-0000-0000-000000000009','22222222-0002-0000-0000-000000000009','11111111-0009-0000-0000-000000000009','Chief concern: grief and emotional overwhelm. Energy findings: Heart chakra opening. Significant emotional release in session.','grief and emotional overwhelm','Heart chakra opening. Significant emotional release in session.','2026-01-10'),
  ('33333333-0003-0000-0000-000000000009','22222222-0003-0000-0000-000000000009','11111111-0009-0000-0000-000000000009','Chief concern: grief and emotional overwhelm. Energy findings: Heart field now clear. Client integrating beautifully.','grief and emotional overwhelm','Heart field now clear. Client integrating beautifully.','2026-03-05'),

  ('33333333-0001-0000-0000-000000000011','22222222-0001-0000-0000-000000000011','11111111-0011-0000-0000-000000000011','Chief concern: energetic overwhelm and anxiety. Energy findings: Overwhelm patterns throughout field. Root ungrounded.','energetic overwhelm and anxiety','Overwhelm patterns throughout field. Root ungrounded.','2025-12-15'),
  ('33333333-0002-0000-0000-000000000011','22222222-0002-0000-0000-000000000011','11111111-0011-0000-0000-000000000011','Chief concern: energetic overwhelm and anxiety. Energy findings: Field grounding better. Anxiety reducing.','energetic overwhelm and anxiety','Field grounding better. Anxiety reducing.','2026-02-01'),

  ('33333333-0001-0000-0000-000000000012','22222222-0001-0000-0000-000000000012','11111111-0012-0000-0000-000000000012','Chief concern: trauma and energetic overwhelm. Energy findings: Complex trauma layering across multiple energy bodies. Dense field.','trauma and energetic overwhelm','Complex trauma layering across multiple energy bodies. Dense field.','2026-01-03'),
  ('33333333-0002-0000-0000-000000000012','22222222-0002-0000-0000-000000000012','11111111-0012-0000-0000-000000000012','Chief concern: trauma and energetic overwhelm. Energy findings: Second trauma layer clearing. Remarkable resilience.','trauma and energetic overwhelm','Second trauma layer clearing. Remarkable resilience.','2026-02-05'),

  ('33333333-0001-0000-0000-000000000015','22222222-0001-0000-0000-000000000015','11111111-0015-0000-0000-000000000015','Chief concern: spiritual disconnect and lack of grounding. Energy findings: Spiritual connection pathways dimmed. Root unanchored.','spiritual disconnect and lack of grounding','Spiritual connection pathways dimmed. Root unanchored.','2026-01-18'),

  ('33333333-0001-0000-0000-000000000017','22222222-0001-0000-0000-000000000017','11111111-0017-0000-0000-000000000017','Chief concern: anxiety and sleep disruption. Energy findings: Scattered mental field. Crown overactive. Root disconnected.','anxiety and sleep disruption','Scattered mental field. Crown overactive. Root disconnected.','2026-01-28'),

  ('33333333-0001-0000-0000-000000000019','22222222-0001-0000-0000-000000000019','11111111-0019-0000-0000-000000000019','Chief concern: trauma and energetic overwhelm. Energy findings: Most complex case to date. Childhood trauma deeply imprinted across all energy bodies.','trauma and energetic overwhelm','Most complex case to date. Childhood trauma deeply imprinted across all energy bodies.','2026-02-06'),
  ('33333333-0002-0000-0000-000000000019','22222222-0002-0000-0000-000000000019','11111111-0019-0000-0000-000000000019','Chief concern: trauma and energetic overwhelm. Energy findings: Field opening significantly post-assessment. Client feeling lighter.','trauma and energetic overwhelm','Field opening significantly post-assessment. Client feeling lighter.','2026-03-12'),

  ('33333333-0001-0000-0000-000000000021','22222222-0001-0000-0000-000000000021','11111111-0021-0000-0000-000000000021','Chief concern: energetic overwhelm and anxiety. Energy findings: Anxiety loops present in mental and emotional fields.','energetic overwhelm and anxiety','Anxiety loops present in mental and emotional fields.','2026-02-14'),

  ('33333333-0001-0000-0000-000000000022','22222222-0001-0000-0000-000000000022','11111111-0022-0000-0000-000000000022','Chief concern: grief and emotional overwhelm. Energy findings: Profound grief imprinting. Heart and solar plexus both affected.','grief and emotional overwhelm','Profound grief imprinting. Heart and solar plexus both affected.','2026-02-18')
ON CONFLICT (id) DO NOTHING;
